...
pub mod firmoto {
    ...
    impl<'a> Operation<'a> {
        ...
        >(
            ...
            if let Some(x) = args.retval {
                builder.add_retval(x);
            }
        ...
        pub fn unpack(&self) -> OperationT {
            ...
            let args = self.args().map(|x| x.iter().map(|t| t.unpack()).collect());
            let retval = self
                .retval()
        ...
        pub fn op_type(&self) -> OperationType {
            ...
            unsafe {
                self._tab
                    .get::<OperationType>(Operation::VT_OP_TYPE, Some(OperationType::GPIO))
                    .unwrap()
            }
        }
        #[inline]
        pub fn sub_op_type(&self) -> SubOperationType {
            ...
            unsafe {
                self._tab
                    .get::<SubOperationType>(
                        Operation::VT_SUB_OP_TYPE,
                        Some(SubOperationType::SPI_WRITE_U8),
                    )
                    .unwrap()
            }
        }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OperationBuilder<'a, 'b, A> {
        ...
        pub fn add_op_type(&mut self, op_type: OperationType) {
            self.fbb_.push_slot::<OperationType>(
                Operation::VT_OP_TYPE,
                op_type,
                OperationType::GPIO,
            );
        }
        ...
        pub fn add_sub_op_type(&mut self, sub_op_type: SubOperationType) {
            self.fbb_.push_slot::<SubOperationType>(
                Operation::VT_SUB_OP_TYPE,
                sub_op_type,
                SubOperationType::SPI_WRITE_U8,
            );
        ...
        pub fn add_retval(
            &mut self,
            retval: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Value<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Operation::VT_RETVAL, retval);
        }
        #[inline]
        pub fn new(
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ReturnValueBuilder<'a, 'b, A> {
        ...
        pub fn add_data(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ReturnValue::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ReturnValueBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            ReturnValueBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    impl ReturnValueT {
        pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
            ...
            ReturnValue::create(_fbb, &ReturnValueArgs { data })
        }
    }
    #[inline]
