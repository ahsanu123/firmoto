- generated with `esp-generate --chip esp32 -o alloc -o embassy -o defmt -o unstable-hal -o neovim -O . --headless firmoto-esp32`
# Setup is not completed yet
Checking installed versions
❌ Rust (esp) (not found - use `espup` to install)
